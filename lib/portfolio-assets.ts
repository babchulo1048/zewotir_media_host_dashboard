// src/data/static/portfolio-assets.ts (New file)
import { PortfolioAsset } from "./models";

export const STATIC_PORTFOLIO_ASSETS: PortfolioAsset[] = [
  {
    id: "uuid-101",
  ...
  },
  {
    ...
    thumbnailUrl:
      "https://res.cloudinary.com/dlujjajxc/image/upload/v1761899408/portfolio_assets/rwck0xctdrrn3jim9hne.jpg",
    tags: ["corporate", "narration", "neutral-accent"],
    isFeatured: false,
    isActive: true,
  ...
  },
  {
    ...
    thumbnailUrl:
      "https://res.cloudinary.com/dlujjajxc/image/upload/v1761899408/portfolio_assets/rwck0xctdrrn3jim9hne.jpg",
    tags: ["drama", "short-film", "director"],
    isFeatured: false,
    isActive: true,
